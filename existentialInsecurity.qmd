...
mot <- read.csv("variables/motivational.csv")
colnames(mot) <- c("Variable Name", "Variable Label", "Description", "Variable Type", "Source (Section)", "Definition")

estab <- mot %>%  filter(`Variable Name`%in% c("Social Trust", "Wealth Inequality", "Social Security") | grepl("^Existential", `Variable Name`) )
